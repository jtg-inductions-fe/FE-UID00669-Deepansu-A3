...
function Carousel({
    ...
    const onSelect = useCallback((carousalApi: CarouselApi) => {
        if (!carousalApi) return;
        setCanScrollPrev(carousalApi.canScrollPrev());
        setCanScrollNext(carousalApi.canScrollNext());
    }, []);
